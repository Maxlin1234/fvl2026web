...
<!-- ---------CSS animation About us--------------->
  ...
  <div class="banner-back"
    style="filter:blur(30px);transform: scale(1.2);position: fixed;z-index:0;">
...
<!-- 三張圖都有 -->
    ...
    <div class="container2" >
          ...
          <!-- <h4 class="artist_title"
           style="font-weight:900;margin-left:60%;">藝術家介紹</h4> -->
    <div class="container3">
      ...
      <div class="about_artist">
        ...
        color:black;
        text-align:left;
        padding: 0.5rem;">藝術家介紹</p>
        <!-- <p class="org-description is-size-4"
         style="color:black;
         text-align: left;
         font-size:0.2rem">{{ $route.params.artist}}</p> -->
