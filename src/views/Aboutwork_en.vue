 ...
 <section class="pg-about section-padding sub-bg">
  ...
  <div class="space_title">
   <!-- <div class="title_background">
    <div class="title">
    <h6 style="margin-bottom: 0;font-weight:800px;">About</h6>
    </div>
   </div> -->
  </div>
  </div>
    ...
    <div class="container3">
      <div class="about_artwork">
        <div class="title-content">
          <p class="org-description is-size-4" style="font-weight:bold;color:black;text-align: left;">{{ this.products.work_en.title }}</p>
          </div>
      ...
      <div class="about_artist">
        <p class="org-description is-size-4" style="font-weight:bold;color:black;text-align: left;padding: 0.5rem;">About artist</p>
...
export default {
  ...
  methods: {
    change_zh() {
      this.$router.push({name: 'Aboutwork'}).then(() => {
  ...
  computed: {
    htmlContent() {
      ...
      return this.products.work_en.proposal|| '';
    },
    artistContent() {
      // 从路由参数获取内容
      return this.products.work_en.note || '';
    },
