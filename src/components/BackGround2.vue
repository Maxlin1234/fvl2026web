...
const geometry = new THREE.IcosahedronGeometry(0, 100);
...
ico2.scale.set(0.5, 0.5, 0.5);
ico2.position.set(1, -1, 11);
scene.add( ico2 );
...
<!-- <div class="gsap-container"
  ref="target" style="position: relative;width:100vw;height:100vh;"> -->
      <div class="gsap-container"
      ref="target" style="width:100vw;height:100vh;z-index: 0;display: flex;">
            </div>
</body>
